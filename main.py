...
teacher = keras.Sequential(
    [
        ...
        # # first hidden layer
        # tf.keras.layers.Conv2D(filters=800, kernel_size=3, strides=1, padding="same"),  # , input_shape=(28, 28, 1)
        # tf.keras.layers.BatchNormalization(),
        # tf.keras.layers.Activation('relu'),
        # tf.keras.layers.MaxPool2D(pool_size=2, strides=2),
        #
        # # second hidden layer
        # tf.keras.layers.Conv2D(filters=800, kernel_size=3, strides=1, padding="same"),
        # tf.keras.layers.BatchNormalization(),
        # tf.keras.layers.Activation('relu'),
        # tf.keras.layers.MaxPool2D(pool_size=2, strides=2),
...
student = keras.Sequential(
    [
        keras.Input(shape=(28, 28, 1)),
        # tf.keras.layers.Conv2D(filters=300, kernel_size=3, strides=1, padding="same"),
        # tf.keras.layers.BatchNormalization(),
        # tf.keras.layers.Activation('relu'),
        # tf.keras.layers.MaxPool2D(pool_size=2, strides=2),
        #
